#!/usr/bin/env python3
"""
PF AI Lab 6.0.3 — Launcher with auto-diagnostics
...
What's new in 5.5:
    - IS/OOS ratio gates (reject PF ratio >2.5 or <0.30, WR delta >15pp)
    - IS PF cap penalties (>3.0 x0.80, >4.0 x0.60, >5.0 x0.40)
    - Stricter OOS gates (calmar 0.50, PF 1.30, min trades 25)
    - IS/OOS coherence bonus (up to +0.5 pts)
    - Anti-overfit quality flags and UI indicators
"""
...
def main():
    parser = argparse.ArgumentParser(description='PF AI Lab 6.0.3 — Launcher')
    ...
    print("=" * 60)
    print("  PF AI Lab 6.0.3 — Pre-launch Diagnostics")
    print("=" * 60)
    print()
    ...
    # Launch
    print("=" * 60)
    print(f"  Launching PF AI Lab 6.0.3 on port {args.port}")
